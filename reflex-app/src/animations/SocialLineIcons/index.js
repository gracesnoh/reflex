...
class SocialLineIcons extends PureComponent {
  constructor(props) {
    super(props);
  ...
  c-5,0-9.1,4.1-9.1,9.1s4.1,9.1,9.1,9.1s9.1-4.1,9.1-9.1S35,20.9,30,20.9z"/>
      <InstagramOuterStroke d="M41.5,55.2H18.6C11,55.2,4.8,49,4.8,41.4V18.6C4.8,11,11,4.8,18.6,4.8h22.9c7.6,0,13.7,6.2,13.7,13.7v22.9C55.2,49,49.1,55.2,41.5,55.2z"/>
      <InstagramInnerStroke cx="30" cy="30" r="11.6"/>
      <InstagramCenterCircle cx="44.7" cy="15.2" r="3.3"/>
      </Instagram>
    </Wrapper>
    );
  }

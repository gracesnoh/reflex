...
class LoadingLines extends PureComponent {
	render() {
		...
		return (
			<AnimationContainer>
				<LineContainer fadeTime={[22, 63, 96]}>
					<Line scaleSizes={[0.4, 0.56, 0.58]} />
				</LineContainer>
				<LineContainer top="10px" left="10%" fadeTime={[26, 62, 95]}>
					<Line scaleSizes={[0.58, 0.38, 0.40]} />
				</LineContainer>
				<LineContainer top="20px" left="5%" fadeTime={[28, 64, 97]}>
					<Line scaleSizes={[0.38, 0.42, 0.45]} />
				</LineContainer>
			</AnimationContainer>
		);
	}

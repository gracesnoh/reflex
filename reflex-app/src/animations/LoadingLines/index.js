    ...
    return (
      <AnimationContainer onClick={this.handleOnClick}>
        <LineContainer clicked={this.state.clicked} top="35%" fadeTime={[22, 63, 96]}>
          <Line color={this.props.color} clicked={this.state.clicked} scaleSizes={[0.4, 0.56, 0.58]} />
        </LineContainer>
        <LineContainer clicked={this.state.clicked} top="45%" left="10%" fadeTime={[26, 62, 95]}>
          <Line color={this.props.color} clicked={this.state.clicked} scaleSizes={[0.58, 0.38, 0.40]} />
        </LineContainer>
        <LineContainer clicked={this.state.clicked} top="55%" left="5%" fadeTime={[28, 64, 97]}>
          <Line color={this.props.color} clicked={this.state.clicked} scaleSizes={[0.38, 0.42, 0.45]} />
        </LineContainer>
        </AnimationContainer>
    );
  }
